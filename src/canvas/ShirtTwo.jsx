...
export default function Shirt() {
  ...
  const { nodes, materials } = useGLTF("/saree.glb"); // Load the model

  let fullTexture = useTexture("/one_piece_texture.jpg"); // Load the texture
  let secondTexture = useTexture("/one_piece_texture_2.jpg"); // Load the texture
